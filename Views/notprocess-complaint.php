                        ...
                        <div class="content">
                            ...
                            <div class="module">
                                <div class="module-head">
                                    <h3 class="card-header text-center font-bold font-up py-4">Not Processed Complaints</h3>
                                </div>
                                    ...
                                    <table  id="datatable1" class="table table-bordered table-striped" >
                                        ...
                                        <tbody>
                                            ...
                                            if($_SESSION['user_type']==3 || $_SESSION['user_type']==4 ){
                                                $query = mysqli_query($mysqli, "SELECT * FROM tblcomplaints a INNER JOIN tblcomplaintsdepts b ON a.complaintNumber=b.deptcomplaintNumber where b.deptstatus='pending' and b.departmenttype=".$_SESSION['user_type']);

                                            }
                                            else {
                                               $query = mysqli_query($mysqli, "select * from tblcomplaints where status='pending' "); 
                                            }
